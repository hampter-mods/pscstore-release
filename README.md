...
- Homebrew games
  ...
  - Zhamul:
    ...
    - [Where in the pils is Fitzgerald?](https://zhamul.itch.io/where-in-the-pils-is-fitzgerald-ps1)
  - rubixcube6:
  ...
  - Bonnie Games:
    - [Celeste Classic PS1 Collection](https://bonnie-studios.itch.io/celeste-classic-collection-psx)
  - KasaBranca:
    - [Penguins!](https://achrostel.itch.io/penguins-ss25)
    - [Tiny Backrooms](https://github.com/KasaBranca/TinyBackrooms/releases)
  - fgsfdsfgs:
    - [QuakePSX](https://github.com/fgsfdsfgs/quakepsx/releases/tag/latest-shareware)
  - Bonnie Studios:
    - [QuakePSX](https://bonnie-studios.itch.io/quake-psx)
  - Elias Daler:
    - [Yume Nikki](https://eliasdaler.itch.io/yume-nikki-ps1)
  - Jimmy Breck-McKye:
    - [Nortis](https://github.com/jbreckmckye/nortis/releases)
